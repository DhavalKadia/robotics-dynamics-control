...
% Problem: obtain the control input A1 and A2 so that toy comes to nearby -15
% The [lo, up] = [-30, -28.4375] above the SAT in termila gives the value of A1.
% The [lo, up] = [-30, -26.875] above the SAT in termila gives the value of A2.
...
while ~queue.isempty()
    ...
    oi_1 = function_1(domain)   % represents the final position of toy [should be between [x3 - eps, x3 + eps]
    
    [sat_1, unsat_1] = lesser(oi_1, x3 + eps);
    [sat_2, unsat_2] = greater(oi_1, x3 - eps);
